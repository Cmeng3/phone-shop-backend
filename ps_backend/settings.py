...
MIDDLEWARE = [
    ...
    'common.middleware.WorkspaceLoginRequiredMiddleware',
...
STATICFILES_DIRS = [('ui', BASE_DIR.parent / 'phone-shop-frontend' / 'dist')] if (BASE_DIR.parent / 'phone-shop-frontend' / 'dist').exists() else []
